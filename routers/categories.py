...
@routerCategory.get("/{category_id}", response_model=CategoryResponse)
...
@routerCategory.put("/{category_id}", response_model=CategoryResponse)
def update_category_endpoint(category_id: int, data: CategoryUpdate, db: Session = Depends(get_db)):
